...
<template id="tmp_competency_form">
    <div class="form-row competency-row justify-content-between" data-row-num="__data-row-num">
        <div class="form-group col-9">
            <input type="text" class="form-control" value="__value1" placeholder="text" name="__name">
        </div>
