...
class EmailApi
{
    ...
    {
        $this->sendEmailWithHttpInfo($body);
    }
     ...
     */
    public function sendEmailAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailAsyncWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->sendEmailRequest($body);
     ...
     */
    protected function sendEmailRequest($body = null)
    {
