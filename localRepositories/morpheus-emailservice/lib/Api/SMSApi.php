...
class SMSApi
{
     ...
     * @return void
     */
    public function sendSMS($body = null)
    {
     ...
     */
    public function sendSMSWithHttpInfo($body = null)
    {
        $returnType = '';
     ...
     */
    public function sendSMSAsync($body = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendSMSAsyncWithHttpInfo($body = null)
    {
        $returnType = '';
        $request = $this->sendSMSRequest($body);
     ...
     */
    protected function sendSMSRequest($body = null)
    {
